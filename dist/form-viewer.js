...
angular.module('mwFormViewer').directive('mwPriorityList', function () {
    ...
    return {
        ...
        link: function link(scope, ele, attrs, mwFormQuestion) {
            var ctrl = scope.ctrl;
...
angular.module('mwFormViewer').directive('mwFormViewer', ["$rootScope", function ($rootScope) {
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$scope", "$timeout", "$interpolate", function controller($scope, $timeout, $interpolate) {
            var ctrl = this;
            // Put initialization logic inside `$onInit()`
            // to make sure bindings have been initialized.
...
angular.module('mwFormViewer').factory("FormQuestionId", function () {
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$timeout", "FormQuestionId", function controller($timeout, FormQuestionId) {
            var ctrl = this;
        ...
        link: function link(scope, ele, attrs, mwFormViewer) {
            var ctrl = scope.ctrl;
